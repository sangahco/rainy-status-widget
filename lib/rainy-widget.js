...
(function () {
    ...
    var RainyWidget = function (_React$Component2) {
        _inherits(RainyWidget, _React$Component2);

        function RainyWidget() {
            _classCallCheck(this, RainyWidget);

            return _possibleConstructorReturn(this, (RainyWidget.__proto__ || Object.getPrototypeOf(RainyWidget)).apply(this, arguments));
        }

        _createClass(RainyWidget, [{
            key: "render",
            value: function render() {
                return React.createElement(
                    "div",
                    null,
                    React.createElement(RainyStatus, { name: "status1" }),
                    React.createElement(RainyStatus, { name: "status2" }),
                    React.createElement(RainyStatus, { name: "status3" }),
                    React.createElement(RainyStatus, { name: "status4" }),
                    React.createElement(RainyStatus, { name: "status5" })
                );
            }
        }]);
    ...
    var element = React.createElement(RainyWidget, null);
